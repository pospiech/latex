...
% -------------------------------------------------------------------------
\section{Features of the temlate}
...
\minisec{Math and scientific notations}
\begin{itemize}
...
\minisec{Figure, Images, placement and captions}
\begin{itemize}
%
...
\minisec{Diagrams and scientific plots}
\begin{itemize}
...
\minisec{Index, Glossary, Acronym list, Symbol list}
\begin{itemize}
\item imakeidx
\item glossaries
\end{itemize}
