...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Glossary}
\label{sec:example:glossary}
\index{example!glossary}
% use the symbols in a document.
Glossary entries are used with \cs{gls\{entry\}}. The following text uses the entrys for CD and DVD:  \cs{gls\{glos:CD\}}, \cs{gls\{glos:DVD\}}:
...
The following text uses definitions of acronyms in a document:
