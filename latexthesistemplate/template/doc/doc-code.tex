...
\item \file{preamble/packages-SolutionsNoRoomForNewWrite.tex}
\end{itemize}
...
\labelfile{preamble/packages-SolutionsNoRoomForNewWrite.tex}

This file loads either the packages \package{scrwfile} or \package{morewrites} and
\package{etex}. 

\printCodeFromFile[1]{1000}{preamble/packages-SolutionsNoRoomForNewWrite.tex}
