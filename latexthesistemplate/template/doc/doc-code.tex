...
% =========================================================================
\chapter{Main file (LuaLaTeXTemplate.tex)}
\label{chap:doc:MainFile}
\labelfile{LuaLaTeXTemplate.tex}
...
%%?  file: LuaLaTeXTemplate.tex
%%? start: % ~~~~~~~~~
%%?   end: % no package or option required
...
With the following files custom macros (\file{macros/newcommands.tex}) and additional hyphenation patterns \file{content/hyphenation.tex} are loaded. 
%%?  file: LuaLaTeXTemplate.tex
%%? start: % ~~~~~~~~~
...
%%?  file: LuaLaTeXTemplate.tex
%%? start: % ~~~~~~~~~~
%%?   end: \input{content/Z-GlossaryEntries.tex}
%
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
%%?  file: LuaLaTeXTemplate.tex
%%? start: \frontmatter
%%?   end: \IfPackageLoaded{scrlayer-scrpage}{\pagestyle{scrheadings}}
...
If you experience problems with the number of \cs{write} outputs used it could
help to disable this list.
For more information see \cref{sec:problems:write}.

%%?  file: LuaLaTeXTemplate.tex
%%? start: %% -- List of Listings --
%%?   end: \IfDefined{lstlistoflistings}
...
This section loads the packages for font loading and font modifications. The fonts are loaded in the file  \file{fonts/fonts.tex}.
...
The base package for all math in \latex is the package \package{amsmath}. The other packages are not necessary, but some of them provide useful bug fixes and enhancement to the math commands and environments defined by \package{amsmath}. The package \package{unicode-math} is essential for loading of math fonts.
...
Standard \latex tables are just ugly. In order to create good looking or even fancy tables further packages are necessary. The most recommend package is \package{tabularray}.

%\begin{itemize}[noitemsep]
%\item \package{booktabs}
%\item \package{multirow}, \package{bigstrut}
%\item \package{ltxtable}, \package{tabularx}, \package{longtable}
%\item \package{tabularray}
...
\package{scrlayer-scrpage}, with the settings defined in file 
\file{preamble/style-scrlayer-scrpage.tex}.

The total number of page is provided by package \package{pageslts}.

%\begin{itemize}[noitemsep]
%	\item \package{scrlayer-scrpage}
...
Configuration of the (automatic) content in header and footer for \package{scrlayer-scrpage} defined in file \file{preamble/style-scrlayer-scrpage.tex}.
...
\labelfile{preamble/style-scrlayer-scrpage.tex}

Configuration of header and footer defined by package \package{scrlayer-scrpage}. 

\printCodeFromFile[1]{1000}{preamble/style-scrlayer-scrpage.tex}
...
Configuration of package \package{hyperref}. The option \emph{pdfpagelayout} is not included here because it should be set up by the user of the template. It is therefore in file \file{LuaLaTeXTemplate.tex}, see section \vref{sec:preamble:configuration}.
...
This file provides examples for loading fonts. The default font is \emph{Latin Modern}, loaded with package \package{unicode-math}. 
...
The structure of this part inside \file{LuaLaTeXTemplate.tex} is described in  \vref{sec:document:content}.
...
Note that this file must be loaded before \cs{begin}\arg{document}.
