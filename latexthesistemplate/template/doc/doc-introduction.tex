...
%\caption[Execution times of the template divided into compilation steps]{Execution times of the template divided into compilation steps. The largest execution times come from the major packages. . Note that these times were measured with the packages loaded by the texlive version of Mai 2023.}
%% old times are from January 2013 with pdflatex engine.
...
%%  \begin{longtabu} to \textwidth%
	...
	\begin{longtblr}[
		...
		\hline
		% multicolumn line
		\SetCell[c=3]{l,bg=tablesubheadcolor} Options in file: \file{LuaLaTeXTemplate.tex} \\
		%
		paper size & paper=a4 & 
