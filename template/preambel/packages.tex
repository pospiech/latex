...
% tikz and pgf
\input{preambel/packages-tikzpgf.tex}
...
%              It is more ﬂexible than tabular, tabular*, tabularx and array
...
% Description: enables typesetting a narrow ﬂoat at the edge of the text,
...
%              table of contents and lists of ﬂoats.
