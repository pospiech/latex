...
This document (\path{content/demo/demo.tex}) could also be used in other templates provided that all depending packages are loaded. 
...
}{\DemoError{Command \cs{ovalbox} not available.}}%
%
%% ------------------------------------------------------------
\begin{filecontents*}{\democodefile}
\begin{framed}
