...
This document (\path{content/demo/demo.tex}) could also be used in other templates provided that all depending packages\footnote{\package{templatesection}, \package{templatetools} and \package{templatedemo}} are loaded. 
