...
%
The backend and encodings for \demopackage{biblatex} are configured in a different file:
\printCodeFromFile[89]{97}{LaTeXTemplate.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Custom definitions}
With the following files custom macros (\file{macros/newcommands.tex} and additional hypernation patterns \file{preamble/Hyphenation.tex} are loaded. 
...
style, which requires the \demopackage{longtable} package is loaded. If you do 
...
\file{preamble/style-glossaries.tex}.
...
\printCodeFromFile[1]{24}{preamble/packages.tex}
...
\printCodeFromFile[25]{76}{preamble/packages.tex}
...
\printCodeFromFile[77]{112}{preamble/packages.tex}
...
\printCodeFromFile[113]{123}{preamble/packages.tex}
...
\printCodeFromFile[125]{209}{preamble/packages.tex}
...
Since \demopackage{tikz} and \demopackage{pgf} come with many options and 
extension package they are loaded in an extra file 
\file{preamble/packages-tikzpgf.tex}. The package \demopackage{pgfplots} 
...
\printCodeFromFile[210]{229}{preamble/packages.tex}

% .........................................................................
\subsubsection{preamble/packages-tikzpgf.tex}
\labelfile{preamble/packages-tikzpgf.tex}

\printCodeFromFile[1]{92}{preamble/packages-tikzpgf.tex}
...
\printCodeFromFile[230]{261}{preamble/packages.tex}
...
\printCodeFromFile[263]{289}{preamble/packages.tex}
...
\printCodeFromFile[290]{325}{preamble/packages.tex}
...
\printCodeFromFile[326]{430}{preamble/packages.tex}
...
\printCodeFromFile[332]{447}{preamble/packages.tex}
...
\printCodeFromFile[448]{494}{preamble/packages.tex}
...
\printCodeFromFile[495]{532}{preamble/packages.tex}
...
\printCodeFromFile[533]{584}{preamble/packages.tex}
...
\printCodeFromFile[585]{600}{preamble/packages.tex}
...
\printCodeFromFile[601]{635}{preamble/packages.tex}
...
The style of \demopackage{listings} is defined in file 
...
\printCodeFromFile[636]{664}{preamble/packages.tex}
...
\printCodeFromFile[665]{699}{preamble/packages.tex}
...
for package \demopackage{geometry} in file \file{preamble/style-geometry.tex}.
...
\printCodeFromFile[742]{778}{preamble/packages.tex}
...
\printCodeFromFile[780]{793}{preamble/packages.tex}
...
\printCodeFromFile[794]{837}{preamble/packages.tex}
...
\printCodeFromFile[838]{895}{preamble/packages.tex}
...
\printCodeFromFile[896]{918}{preamble/packages.tex}
...
\printCodeFromFile[1]{27}{preamble/style.tex}
...
\printCodeFromFile[28]{69}{preamble/style.tex}
...
\printCodeFromFile[70]{96}{preamble/style.tex}
...
\printCodeFromFile[97]{105}{preamble/style.tex}
...
\printCodeFromFile[1]{36}{preamble/style-siunitx.tex}
...
\printCodeFromFile[106]{126}{preamble/style.tex}
...
\printCodeFromFile[1]{31}{preamble/style-pgfplots.tex}
...
\printCodeFromFile[127]{145}{preamble/style.tex}
...
\printCodeFromFile[146]{186}{preamble/style.tex}
...
\printCodeFromFile[187]{208}{preamble/style.tex}
...
\printCodeFromFile[209]{220}{preamble/style.tex}
...
\printCodeFromFile[1]{135}{preamble/style-biblatex.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Figures, placement and floats}

Configuration of variable for package \demopackage{wrapfig} (if loaded) and 
general modifications of float placement variables to make the placement of 
many floating figures easier.

\printCodeFromFile[221]{246}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Captions}

In this section the visual appearance and numbering of captions is configured 
for the packages \demopackage{caption}, \demopackage{subcaption}, 
\demopackage{subfig} and \demopackage{floatrow}. 
The package \demopackage{subfig} however is not 
recommended and can only be used without \demopackage{subcaption}.

\printCodeFromFile[247]{264}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-caption.tex}
\labelfile{preamble/style-caption.tex}

In this file the standard caption style with name \emph{captionStyleTemplateDefault} is defined and applied via \democs{captionsetup}. Furthermore a version for short captions is defined with the name \emph{captionStyleTemplateShortDefault}, which is then applied for all wrap style and margin figures.
...
\printCodeFromFile[1]{119}{preamble/style-caption.tex}

% .........................................................................
\subsubsection{preamble/style-floatrow.tex}
\labelfile{preamble/style-floatrow.tex}

Several settings of package \demopackage{floatrow} are set up and float styles are defined with \democs{floatsetup}.

\printCodeFromFile[1]{238}{preamble/style-floatrow.tex}
...
\printCodeFromFile[265]{297}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Index and glossaries and other lists}

\printCodeFromFile[298]{306}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-index.tex}
\labelfile{preamble/style-index.tex}

Setup for package \demopackage{imakeidx}.

\printCodeFromFile[1]{12}{preamble/style-index.tex}

% .........................................................................
\subsubsection{preamble/style-glossaries.tex}
\labelfile{preamble/style-glossaries.tex}

Configuration for package \demopackage{glossaries}. New styles are defined with \democs{newglossarystyle} and with the use of package \demopackage{translator} the headings are translated for the german language.

\printCodeFromFile[1]{83}{preamble/style-glossaries.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Verbatim and listings packages}

\printCodeFromFile[307]{314}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-listings.tex}
\labelfile{preamble/style-listings.tex}

First a new basic style with name \emph{lstStyleBase} is defined using \democs{lstdefinestyle}. Then Programming dependend styles are loaded in subfiles and in the end activated with \democs{lstloadlanguages}.

\printCodeFromFile[1]{97}{preamble/style-listings.tex}
...
\printCodeFromFile[1]{100}{preamble/listings-latex.tex}
...
\printCodeFromFile[1]{39}{preamble/listings-cpp.tex}


% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Fancy packages}

Configuration for package \demopackage{lettrine} and package \demopackage{framed}.

\printCodeFromFile[315]{333}{preamble/style.tex}
...
\printCodeFromFile[334]{355}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Layout: line spacing}

Configuration of line spacing with package \demopackage{setspace}.

\printCodeFromFile[356]{365}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Layout: page layout}

Configuration of package \demopackage{goemtry} or package \demopackage{typearea}.

\printCodeFromFile[366]{436}{preamble/style.tex}
...
\printCodeFromFile[437]{445}{preamble/style.tex}
...
\printCodeFromFile[446]{453}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-scrpage2.tex}
\labelfile{preamble/style-scrpage2.tex}

Configuration of header and footer defined by package \demopackage{scrpage2}. 

\printCodeFromFile[1]{100}{preamble/style-scrpage2.tex}
...
\printCodeFromFile[454]{493}{preamble/style.tex}
...
\printCodeFromFile[494]{546}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Headings: custom layout}

\printCodeFromFile[547]{560}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-titlesec.tex}
\labelfile{preamble/style-titlesec.tex}

Changes to the layout of headings with package \demopackage{titlesec}. 

\printCodeFromFile[1]{100}{preamble/style-titlesec.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Settings and layout of table of contents and other lists}

Configuration of counter \emph{tocdepth}, options of koma-script, package \demopackage{tocstyle} and koma-script specific fonts and general options for lists.

\printCodeFromFile[561]{662}{preamble/style.tex}

% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\subsection{Settings and layout of table of contents and other lists}

Configuration of packages \demopackage{hyperref}, \demopackage{bookmark} and the creation \demopackage{hyperref} depended reference commands.

\printCodeFromFile[663]{690}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/style-hyperref.tex}
\labelfile{preamble/style-hyperref.tex}

Configuration of package \demopackage{hyperref}. The option \emph{pdfpagelayout} is not included here because it should be set up by the user of the template. It is therefore in file \file{LaTeXTemplate.tex}, see section \vref{sec:main:Configuration}.

\printCodeFromFile[1]{100}{preamble/style-hyperref.tex}

% .........................................................................
\subsubsection{preamble/style-references.tex}
\labelfile{preamble/style-references.tex}

Provides the commands \democs{eqnref}, \democs{figref}, \democs{tabref}, \democs{secref} and \democs{chapref}, which behave like \democs{ref} but also include the name of the thing to reference in the hyperlink.

Something similar and is achieved by the package \demopackage{cleveref} which does the same thing in a more clever way.

\printCodeFromFile[1]{100}{preamble/style-references.tex}
...
The commands \democs{frontmatter}, \democs{mainmatter} and \democs{backmatter} are defined if they are not defined. This happens for example if the class \emph{scrartcl} is loaded.

\printCodeFromFile[691]{731}{preamble/style.tex}

% .........................................................................
\subsubsection{preamble/fix-tabu-onlyamsmath.tex}
\labelfile{preamble/fix-tabu-onlyamsmath.tex}

The package \demopackage{tabu} has a problem with the \$-char if it was redefined by package \demopackage{onlyamsmath}. Here the original definition is restored for every tabu tabular to solve the problem.
...
the placement of margin notes of package \demopackage{marginnote} is wrong next to frames created by package \demopackage{framed}. This is corrected here.
...
\begin{itemize}
\item \democs{marginwidth} defines the margin width
\item \democs{doctextwidth} and \democs{doctextheight} define the width and height of the document text area.
\end{itemize}
...
Contains all hyphenation patterns inside of the command \democs{hyphenation}.
...
\democs{makeindex}, \democs{makeglossaries} and \democs{linenumbers}.
...
The structure of this part inside \file{LaTeXTemplate.tex} is described in  \vref{sec:main:document}.

% -------------------------------------------------------------------------
\section{content/Z-Acronyms.tex}
\labelfile{content/Z-Acronyms.tex}

Definition of acronyms using command \democs{newacronym} from package \demopackage{glossaries}.
...
Here different approaches to generate a title are shown. The first uses \democs{maketitle} which however is difficult to modify and therefore not used. The title used makes use of several \cs{vspace} commands for manual alignment. The same layout is shown as a template for bachelor and master thesis. For phd-thesis however it usually must be created according to the rules of the university.
...
This CV is based on my own phd thesis and created with package \demopackage{currvita}. A CV should only be part of a phd thesis, not a bachelor or master thesis.
...
This code prints out a todo list created by commands of package \demopackage{todonotes}.
...
\demopackage{biblatex}. Simply run you bibliography tool to get create bbl file.
...
Package \demopackage{tocstyle} prints out the following warning:
%
\begin{verbatim}
...
Package \demopackage{hypennat} prints out the following warning:
%
\begin{verbatim}
...
Package \demopackage{hypennat} warns about the use of package \demopackage{pdfpages}:
%
\begin{verbatim}
