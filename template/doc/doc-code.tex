...
The backend and encodings for \package{biblatex} are configured in \file{preamble/packages.tex} together with the loading of the package, see \cref{sec:preamble:bibliography}.
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
All package groups, named within this text \emph{sections}, start with the command \cs{BeginTemplateSection} and end with \cs{EndTemplateSection}. If these section are included in the compilation or excludes (not compiled) is defined at the beginning of the file:
...
Loading of the settings file \file{preamble/style-biblatex.tex} for package \package{biblatex} and principle layout of the bibliography items.
...
Configuration of package \package{goemtry} or package \package{typearea}.
...
Configuration of package \package{hyperref}. The option \emph{pdfpagelayout} is not included here because it should be set up by the user of the template. It is therefore in file \file{LaTeXTemplate.tex}, see section \vref{sec:main:Configuration}.
